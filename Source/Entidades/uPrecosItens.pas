...
begin
  ...
  2: FEntidadeBase.TextoSQL(
      'Select pi.codigo, pi.cod_precos, p.descricao as nome_prod, p.multiplicador as multiplicador_base, p.flg_usa_preco_custo, ' +
      'pd.preco_cust, pi.preco, pi.preco as preco_vend, ' +
