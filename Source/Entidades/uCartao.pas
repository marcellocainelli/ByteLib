...
begin
  ...
  FEntidadeBase.SetReadOnly(Value, 'tef_pinpad', False);
end;
...
begin
  FEntidadeBase.TextoSQL(
    'select c.*, o.nome as operadora, o.tipo_operacao, o.flg_gera_transferencia_banco, o.flg_nao_gera_cashback, o.tef_pinpad ' +
